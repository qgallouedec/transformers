...
class SiLUActivation(nn.Module):
    """
    See Gaussian Error Linear Units (Hendrycks et al., https://huggingface.co/papers/1606.08415) where the SiLU (Sigmoid Linear
    Unit) was originally introduced and coined, and see Sigmoid-Weighted Linear Units for Neural Network Function
    Approximation in Reinforcement Learning (Elfwing et al., https://huggingface.co/papers/1702.03118) and Swish: a Self-Gated
    Activation Function (Ramachandran et al., https://huggingface.co/papers/1710.05941v1) where the SiLU was experimented with
    later.
    """
...
class XIELUActivation(nn.Module):
    """
    Applies the xIELU activation function introduced in https://huggingface.co/papers/2411.13010
